...
class MigrationServiceProvider extends ServiceProvider
{
    ...
    {
        $commands = ['Migrate', 'Rollback', 'Reset', 'Refresh', 'Install', 'Make', 'Status', 'Lullaby'];
        ...
        $this->commands(
            ...
            'command.migrate.status', 'command.migrate.lullaby'
        );
    }
     ...
     * @return void
     */
    protected function registerLullabyCommand()
    {
        $this->registerCreator();

        $this->app->singleton('command.migrate.lullaby', function ($app) {
            // Once we have the migration creator registered, we will create the command
            // and inject the creator. The creator is responsible for the actual file
            // creation of the migrations, and may be extended by these developers.
            $creator = $app['migration.creator'];
            ...
            return new MigrateLullabyCommand($creator, $composer);
        });
    }
